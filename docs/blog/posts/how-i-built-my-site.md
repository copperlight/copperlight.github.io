...
[Install the Latest Python Versions on Mac OSX]: install-the-latest-python-versions-on-macosx.md
...
branch which is used by GitHub Actions and Pages. The static HTML site generated by this process
will be pushed to the `gh-pages` branch at the origin for this repository. Changes will be live
within one minute. Navigate to the site url to see your changes, after you have configured the
Pages source branch in Repo Settings.
...
1. Code > Description
2. Code > Website
3. Code > Manage topics
4. Settings > Branches > Protected branches: `main`
    1. Check: Protect this branch
    2. Check: Include administrators
5. Settings > Pages > Source
    1. Branch: `gh-pages`
    2. Folder: `/ (root)`
